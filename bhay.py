...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Please contact @ITSSOMSXD for the access of the bot."
...
✅ Usage: /remove <userid>'''
        ...
        response = "To get access of the bot please contact @ITSSOMSXD🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "free ka maal nahi milta bhai buy karlo:- @ITSSOMSXD 🙇."
    bot.reply_to(message, response)
...
English- Hi bro. How are you? I see that you are not sharing feedback 👀

हिन्दी - नमस्ते भाई. कैसे हो? देख रहा हूँ कि तुम फीडबैक नहीं दे रहे हो 👀


REGARDS - @XYRODDOS''')
            except Exception as e:
                print(f"Failed to send message to {user_id}: {e}")
        time.sleep(2000)  # Wait 30 minutes before sending the message again
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                attack_start_message = (
                    ...
                    f"𝐏𝐨𝐫𝐭: {port}\n"
                    f"𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n"
                    f"𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of :- @ITSSOMSXD."
                )
        ...
        response = "🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @ITSSOMSXD"
